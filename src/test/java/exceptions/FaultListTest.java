...
public class FaultListTest {
    ...
    public void processing() {
        ...
        expected.add("2," + ProcessingResult.WORD_COUNT_ERROR.getErrorCode());
        expected.add("3," + ProcessingResult.VALUE_ERROR.getErrorCode());
        expected.add("5," + ProcessingResult.DATE_ERROR.getErrorCode());
        expected.add("6," + ProcessingResult.VALUE_AND_DATE_ERROR.getErrorCode());
